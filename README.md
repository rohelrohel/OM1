...
If you are new to OM1, start by reading this documentation before exploring the source code.
OM1 is modular by design, meaning each component can be understood independently.
New contributors are encouraged to begin with documentation updates and examples.
